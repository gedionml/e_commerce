...
<div class="max-w-2xl mx-auto mt-10 bg-white rounded-xl shadow-lg p-8">
    <h1 class="text-2xl font-bold mb-6 text-blue-700">Add New Product</h1>
    @if ($errors->any())
    ...
    <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="relative">
                <input type="text" id="name" name="name" required class="peer h-12 w-full border-b-2 border-gray-300 text-gray-900 placeholder-transparent focus:outline-none focus:border-blue-600" placeholder="Name" value="{{ old('name') }}" />
            ...
            <div class="relative">
                <input type="text" id="category" name="category" class="peer h-12 w-full border-b-2 border-gray-300 text-gray-900 placeholder-transparent focus:outline-none focus:border-blue-600" placeholder="Category" value="{{ old('category') }}" />
            ...
            <div class="relative">
                <input type="number" step="0.01" id="price" name="price" required class="peer h-12 w-full border-b-2 border-gray-300 text-gray-900 placeholder-transparent focus:outline-none focus:border-blue-600" placeholder="Price" value="{{ old('price') }}" />
            ...
            <div class="relative">
                <input type="number" id="quantity" name="quantity" min="0" required class="peer h-12 w-full border-b-2 border-gray-300 text-gray-900 placeholder-transparent focus:outline-none focus:border-blue-600" placeholder="Quantity" value="{{ old('quantity', 0) }}" />
        ...
        <div class="relative">
            <textarea id="description" name="description" rows="3" class="peer w-full border-b-2 border-gray-300 text-gray-900 placeholder-transparent focus:outline-none focus:border-blue-600 resize-none" placeholder="Description">{{ old('description') }}</textarea>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                <label for="image" class="block text-gray-700 mb-2">Main Product Image</label>
            ...
            <div>
                <label for="images" class="block text-gray-700 mb-2">Additional Images</label>
        ...
        <div class="flex space-x-4 mt-6">
            <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white font-semibold px-6 py-2 rounded shadow">Create Product</button>
